...
export function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-110 bg-background border-b border-border">
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-16 md:top-20 left-0 right-0 bg-background border-b border-border z-100 shadow-xl max-h-[calc(100vh-4rem)] md:max-h-[calc(100vh-5rem)] overflow-y-auto"
            >
              <div className="container px-4 md:px-6 lg:px-8 py-8 md:py-12">
                ...
                <div className="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-border flex flex-col items-center gap-4">
