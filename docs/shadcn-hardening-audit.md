...
| Theme controls                            | Remove the obsolete contrast toggle and multi-theme runtime.               | Done; the public app now has one neutral semantic theme and no theme-provider state.                                                                          |
