          ...
          <div className="max-w-2xl mx-auto">
            <ul className="space-y-4">
              {benefits[locale as keyof typeof benefits].map((benefit, index) => (
                <li key={index} className="flex items-center gap-4 p-4 bg-background rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {transformations.docs.map((item) => {
                ...
                return (
                  ...
                  >
                    <article className="bg-background rounded-lg overflow-hidden border transition-shadow hover:shadow-lg">
                      {coverImage?.url && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {services.docs.map((service) => (
                <Link
                  ...
                  className="group p-6 bg-muted rounded-lg hover:bg-primary/10 transition-colors"
                >
