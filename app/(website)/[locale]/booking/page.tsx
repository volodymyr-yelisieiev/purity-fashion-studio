...
export default async function BookingPage({ searchParams }: BookingPageProps) {
  ...
  const content = {
    uk: {
      ...
      unavailable: 'Система бронювання тимчасово недоступна. Будь ласка, зв\'яжіться з нами за телефоном.',
    },
    ru: {
      ...
      unavailable: 'Система бронирования временно недоступна. Пожалуйста, свяжитесь с нами по телефону.',
    },
    en: {
      ...
      unavailable: 'Booking system is temporarily unavailable. Please contact us by phone.',
    },
  }
    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-5xl mx-auto">
        ...
        <header className="text-center mb-12">
          <span className="block mb-4 font-serif text-3xl font-light text-foreground md:text-4xl">{t.title}</span>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-card border p-6">
                <span className="block font-serif text-xl font-light mb-4 text-foreground">{t.contactTitle}</span>
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <a href="tel:+380441234567" className="text-foreground hover:text-muted-foreground transition-colors">
                      +38 (044) 123-45-67
                    </a>
                  </li>
                  <li className="flex items-start gap-3">
                    <Mail className="h-5 w-5 text-muted-foreground mt-0.5 shrink-0" />
                    <a href="mailto:booking@purity.style" className="text-foreground hover:text-muted-foreground transition-colors">
