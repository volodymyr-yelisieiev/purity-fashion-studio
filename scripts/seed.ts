...
const seed = async () => {
  ...
  const collectionsToClean = ['portfolio', 'products', 'lookbooks', 'courses', 'services', 'media']
  for (const collection of collectionsToClean) {
    const docs = await payload.find({ collection: collection as any, limit: 1000 })
    await Promise.all(docs.docs.map((doc) => payload.delete({ collection: collection as any, id: doc.id })))
  }
  ...
  const placeholderImageUrl = 'https://images.unsplash.com/photo-1512436991641-6745cdb1723f?q=80&w=2070&auto=format&fit=crop'
  ...
  await createService({
    ...
    steps: [
      {
        title: { en: 'Initial Consultation', uk: 'Початкова консультація', ru: 'Начальная консультация' },
        description: { en: 'We discuss your style goals, lifestyle needs, and preferences.', uk: 'Ми обговорюємо ваші цілі стилю, потреби способу життя та вподобання.', ru: 'Мы обсуждаем ваши цели стиля, потребности образа жизни и предпочтения.' },
      },
      {
        title: { en: 'Style Analysis', uk: 'Аналіз стилю', ru: 'Анализ стиля' },
        description: { en: 'Detailed analysis of your body type, color type, and personality.', uk: 'Детальний аналіз вашого типу фігури, кольоротипу та особистості.', ru: 'Детальный анализ вашего типа фигуры, цветотипа и личности.' },
      },
      {
        title: { en: 'Concept Development', uk: 'Розробка концепції', ru: 'Разработка концепции' },
        description: { en: 'Creating a visual moodboard for your new style direction.', uk: 'Створення візуального мудборду для вашого нового напрямку стилю.', ru: 'Создание визуального мудборда для вашего нового направления стиля.' },
      },
      {
        title: { en: 'Outfit Curation', uk: 'Кураторство образів', ru: 'Кураторство образов' },
        description: { en: 'Selecting specific items and assembling complete looks.', uk: 'Вибір конкретних речей та складання повних образів.', ru: 'Выбор конкретных вещей и составление полных образов.' },
      },
      {
        title: { en: 'Final Delivery', uk: 'Фінальна доставка', ru: 'Финальная доставка' },
        description: { en: 'Receiving your digital lookbook with shopping links.', uk: 'Отримання вашого цифрового лукбука з посиланнями на покупки.', ru: 'Получение вашего цифрового лукбука со ссылками на покупки.' },
      }
    ],
    includes: [
      { en: '20+ curated outfits for all occasions', uk: '20+ підібраних образів для всіх подій', ru: '20+ подобранных образов для всех событий' },
      { en: 'Direct shopping links to all items', uk: 'Прямі посилання на всі речі', ru: 'Прямые ссылки на все вещи' },
      { en: 'Body type & color palette guide', uk: 'Гід по типу фігури та кольоровій палітрі', ru: 'Гид по типу фигуры и цветовой палитре' },
      { en: 'Style moodboard & inspiration', uk: 'Мудборд стилю та натхнення', ru: 'Мудборд стиля и вдохновение' },
      { en: '1-week style support via chat', uk: '1 тиждень підтримки стилю через чат', ru: '1 неделя поддержки стиля через чат' },
    ],
    featured: true,
    bookable: true,
  })
  ...
  await createService({
    ...
    steps: [
      {
        title: { en: 'Wardrobe Review', uk: 'Огляд гардеробу', ru: 'Обзор гардероба' },
        description: { en: 'Going through every item to assess fit, condition, and style.', uk: 'Перегляд кожної речі для оцінки посадки, стану та стилю.', ru: 'Просмотр каждой вещи для оценки посадки, состояния и стиля.' },
      },
      {
        title: { en: 'Sorting & Decluttering', uk: 'Сортування та розчищення', ru: 'Сортировка и расчистка' },
        description: { en: 'Deciding what to keep, tailor, donate, or discard.', uk: 'Вирішення, що залишити, перешити, віддати або викинути.', ru: 'Решение, что оставить, перешить, отдать или выбросить.' },
      },
      {
        title: { en: 'New Combinations', uk: 'Нові комбінації', ru: 'Новые комбинации' },
        description: { en: 'Creating fresh outfits from your existing clothes.', uk: 'Створення нових образів з вашого існуючого одягу.', ru: 'Создание новых образов из вашей существующей одежды.' },
      },
      {
        title: { en: 'Shopping List', uk: 'Список покупок', ru: 'Список покупок' },
        description: { en: 'Identifying key pieces missing from your wardrobe.', uk: 'Визначення ключових речей, яких не вистачає у вашому гардеробі.', ru: 'Определение ключевых вещей, которых не хватает в вашем гардеробе.' },
      },
      {
        title: { en: 'Organization', uk: 'Організація', ru: 'Организация' },
        description: { en: 'Arranging your closet for easy daily use.', uk: 'Впорядкування вашої шафи для зручного щоденного використання.', ru: 'Упорядочивание вашего шкафа для удобного ежедневного использования.' },
      }
    ],
    includes: [
      { en: 'Full wardrobe organization', uk: 'Повна організація гардеробу', ru: 'Полная организация гардероба' },
      { en: 'Digital photos of new outfits', uk: 'Цифрові фото нових образів', ru: 'Цифровые фото новых образов' },
      { en: 'Personalized shopping list', uk: 'Персоналізований список покупок', ru: 'Персонализированный список покупок' },
      { en: 'Tailoring recommendations', uk: 'Рекомендації щодо перешиття', ru: 'Рекомендации по перешиву' },
      { en: 'Storage solution tips', uk: 'Поради щодо зберігання', ru: 'Советы по хранению' },
    ],
    featured: false,
    bookable: true,
  })
  ...
  await createService({
    ...
    steps: [
      {
        title: { en: 'Pre-selection', uk: 'Попередній відбір', ru: 'Предварительный отбор' },
        description: { en: 'I visit stores beforehand to find the best pieces.', uk: 'Я відвідую магазини заздалегідь, щоб знайти найкращі речі.', ru: 'Я посещаю магазины заранее, чтобы найти лучшие вещи.' },
      },
      {
        title: { en: 'Fitting Session', uk: 'Сесія примірки', ru: 'Сессия примерки' },
        description: { en: 'We meet and try on the pre-selected items.', uk: 'Ми зустрічаємося і приміряємо заздалегідь відібрані речі.', ru: 'Мы встречаемся и примеряем заранее отобранные вещи.' },
      },
      {
        title: { en: 'Style Coaching', uk: 'Стиль-коучинг', ru: 'Стиль-коучинг' },
        description: { en: 'Learning how to choose quality and fit.', uk: 'Навчання тому, як обирати якість та посадку.', ru: 'Обучение тому, как выбирать качество и посадку.' },
      }
    ],
    includes: [
      { en: 'Pre-selected items in stores', uk: 'Заздалегідь відібрані речі в магазинах', ru: 'Заранее отобранные вещи в магазинах' },
      { en: 'Route planning', uk: 'Планування маршруту', ru: 'Планирование маршрута' },
      { en: 'Budget management', uk: 'Управління бюджетом', ru: 'Управление бюджетом' },
      { en: 'Post-shopping outfit guide', uk: 'Гід по образах після шопінгу', ru: 'Гид по образам после шопинга' },
    ],
    featured: true,
    bookable: true,
  })
  ...
  await createService({
    ...
    steps: [
      {
        title: { en: 'Dossier Creation', uk: 'Створення Досьє', ru: 'Создание Досье' },
        description: { en: 'Creating your personal mannequin for perfect fit.', uk: 'Створення вашого персонального манекена для ідеальної посадки.', ru: 'Создание вашего персонального манекена для идеальной посадки.' },
      },
      {
        title: { en: 'Design Consultation', uk: 'Консультація з дизайну', ru: 'Консультация по дизайну' },
        description: { en: 'Discussing the concept, fabric selection, and sketches.', uk: 'Обговорення концепції, вибір тканини та ескізи.', ru: 'Обсуждение концепции, выбор ткани и эскизы.' },
      },
      {
        title: { en: 'Fittings', uk: 'Примірки', ru: 'Примерки' },
        description: { en: 'Multiple fitting sessions to refine the garment.', uk: 'Кілька сесій примірки для вдосконалення виробу.', ru: 'Несколько сессий примерки для совершенствования изделия.' },
      }
    ],
    includes: [
      { en: 'Personal mannequin (Dossier)', uk: 'Персональний манекен (Досьє)', ru: 'Персональный манекен (Досье)' },
      { en: 'Dress: €500-700', uk: 'Сукня: €500-700', ru: 'Платье: €500-700' },
      { en: 'Jacket: €600-800', uk: 'Жакет: €600-800', ru: 'Жакет: €600-800' },
      { en: 'Hourly rate: €25/hour', uk: 'Погодинна оплата: €25/год', ru: 'Почасовая оплата: €25/час' },
    ],
    featured: true,
    bookable: true,
  })
  ...
  await createService({
    ...
    steps: [
      {
        title: { en: 'Arrival & Opening', uk: 'Прибуття та відкриття', ru: 'Прибытие и открытие' },
        description: { en: 'Settling in and setting intentions.', uk: 'Поселення та встановлення намірів.', ru: 'Поселение и установка намерений.' },
      },
      {
        title: { en: 'Workshops & Practice', uk: 'Воркшопи та практика', ru: 'Воркшопы и практика' },
        description: { en: 'Daily sessions on style and mindfulness.', uk: 'Щоденні сесії зі стилю та усвідомленості.', ru: 'Ежедневные сессии по стилю и осознанности.' },
      }
    ],
    includes: [
      { en: 'Accommodation & Meals', uk: 'Проживання та харчування', ru: 'Проживание и питание' },
      { en: 'All workshops and materials', uk: 'Всі воркшопи та матеріали', ru: 'Все воркшопы и материалы' },
      { en: 'Personal styling session', uk: 'Персональна сесія стайлінгу', ru: 'Персональная сессия стайлинга' },
    ],
    featured: true,
    bookable: true,
  })
    ...
    steps: [
      {
        ...
        description: { en: 'Setting the intention and choosing the atmosphere.', uk: 'Встановлення намірів та вибір атмосфери.', ru: 'Установка намерения и выбор атмосферы.' },
      },
      {
        title: { en: 'The Session', uk: 'Сесія', ru: 'Сессия' },
        description: { en: 'A mindful photography process.', uk: 'Усвідомлений процес фотографії.', ru: 'Осознанный процесс фотографии.' },
      },
      {
        title: { en: 'Reflection', uk: 'Рефлексія', ru: 'Рефлексия' },
        description: { en: 'Reviewing the images and discussing the experience.', uk: 'Перегляд зображень та обговорення досвіду.', ru: 'Просмотр изображений и обсуждение опыта.' },
      }
    ],
    includes: [
      { en: 'Professional photography', uk: 'Професійна фотографія', ru: 'Профессиональная фотография' },
      { en: 'Style preparation', uk: 'Підготовка стилю', ru: 'Подготовка стиля' },
      { en: 'Digital gallery of images', uk: 'Цифрова галерея зображень', ru: 'Цифровая галерея изображений' },
      { en: 'Post-session consultation', uk: 'Консультація після сесії', ru: 'Консультация после сессии' },
    ],
    featured: true,
    bookable: true,
  })
  ...
  const createProduct = async (data: any) => {
    ...
    const doc = await payload.create({
      ...
      data: {
        ...
        excerpt: excerpt.uk,
        description: description.uk,
        priceEUR: rest.pricing?.eur,
        priceUAH: rest.pricing?.uah,
        images: [
          {
            image: media.id,
            alt: name.uk,
  ...
  const createCollection = async (data: any) => {
    const { name, description, materials, careInstructions, sizes, ...rest } = data
    ...
    const doc = await payload.create({
      ...
      data: {
        ...
        coverImage: media.id,
        images: [
          { image: media.id, caption: name.uk }
        ],
        priceEUR: rest.priceEUR,
        priceUAH: rest.priceUAH,
      },
    })
  ...
  const createCourse = async (data: any) => {
    const { title, excerpt, description, prerequisites, materials, instructor, curriculum, testimonials, faq, ...rest } = data
    ...
    const doc = await payload.create({
      ...
      data: {
        ...
        curriculum: curriculum.map((item: any) => ({
          ...
          topics: item.topics.map((t: any) => ({ topic: t.uk })),
        })),
    ...
    await payload.update({
      ...
      data: {
        ...
        curriculum: curriculum.map((item: any) => ({
          ...
          topics: item.topics.map((t: any) => ({ topic: t.en })),
        })),
        testimonials: testimonials?.map((t: any) => ({
          name: t.name,
          quote: t.quote.en,
    ...
    await payload.update({
      ...
      data: {
        ...
        curriculum: curriculum.map((item: any) => ({
          ...
          topics: item.topics.map((t: any) => ({ topic: t.ru })),
        })),
        testimonials: testimonials?.map((t: any) => ({
          name: t.name,
          quote: t.quote.ru,
  ...
  await createCourse({
    ...
    instructor: {
      name: 'Vika Veda',
      title: { en: 'Founder & Creative Director', uk: 'Засновниця та креативний директор', ru: 'Основательница и креативный директор' },
      bio: { en: 'Expert in silk and bespoke tailoring.', uk: 'Експерт із шовку та індивідуального пошиття.', ru: 'Эксперт по шелку и индивидуальному пошиву.' },
    },
    curriculum: [
      {
        module: { en: 'Philosophy', uk: 'Філософія', ru: 'Философия' },
        topics: [{ en: 'The meaning of Victory', uk: 'Значення Перемоги', ru: 'Значение Победы' }],
      },
      {
        module: { en: 'Craftsmanship', uk: 'Майстерність', ru: 'Мастерство' },
        topics: [{ en: 'Silk handling techniques', uk: 'Техніки роботи з шовком', ru: 'Техники работы с шелком' }],
      }
    ],
    priceEUR: 500,
    priceUAH: 20000,
  ...
  await createCourse({
    ...
    curriculum: [
      {
        ...
        topics: [
          ...
          { en: 'Defining Your Style', uk: 'Визначення вашого стилю', ru: 'Определение вашего стиля' },
        ],
      },
    ],
    testimonials: [
    ...
    faq: [
      {
        question: { en: 'Is it for beginners?', uk: 'Це для початківців?', ru: 'Это для начинающих?' },
        answer: { en: 'Yes, absolutely.', uk: 'Так, безумовно.', ru: 'Да, абсолютно.' },
      }
    ],
    upcomingDates: [
      {
    ...
    curriculum: [
      {
        ...
        topics: [
          ...
          { en: 'Psychology of Color', uk: 'Психологія кольору', ru: 'Психология цвета' },
        ],
      },
    ],
    upcomingDates: [
